# go-ruby-devise documentation

**Pure-Go, MRI-4.0.5-faithful Ruby devise (no cgo)**

`go-ruby-devise/devise` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `devise`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-devise/devise`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `devise`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`devise`](https://github.com/go-ruby-devise/devise) | the library — Ruby's `devise` in pure Go |
| [`docs`](https://github.com/go-ruby-devise/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-devise.github.io`](https://github.com/go-ruby-devise/go-ruby-devise.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-devise/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-devise/devise](https://github.com/go-ruby-devise/devise).
