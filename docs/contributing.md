...
Contributions are welcome. `go-ruby-devise/devise` is built to a small set of
...
The library is in [`github.com/go-ruby-devise/devise`](https://github.com/go-ruby-devise/devise).
This documentation site is in [`github.com/go-ruby-devise/docs`](https://github.com/go-ruby-devise/docs).
