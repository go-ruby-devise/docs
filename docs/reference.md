...
The public API lives at the module root (`github.com/go-ruby-devise/devise`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `devise`, while the surface follows
...
```go
import "github.com/go-ruby-devise/devise"
```
...
- **[pkg.go.dev/github.com/go-ruby-devise/devise](https://pkg.go.dev/github.com/go-ruby-devise/devise)**

The module's [README](https://github.com/go-ruby-devise/devise#readme) carries worked
